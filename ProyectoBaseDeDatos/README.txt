...
6. La ventana consulta bote tiene la misma funcionalidad que la anterior solamente en estecaso debera ingresar el serial que tambien se mostrara en consola, para evitar
el cambio de ventana a workbench.
